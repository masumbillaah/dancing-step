...
const About = () => {
    return (
        <div className="text-center p-4">
            <div>
                <h4 className='text-danger'>PROGRAM</h4>
            ...
            <div className='d-flex p-5'>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <img src="https://s3.amazonaws.com/ClubExpressClubFiles/893257/photos/screen/EPP_5608_2083572691.png" alt="" />
                    </div>
                </div>
            </div>
            <div>
                ...
                <p>Email: <a href="#">DanceSteps15@gmail.com</a> </p>
            </div>
        </div>
    );
};
